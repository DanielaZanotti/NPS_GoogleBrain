...
############################### LOAD DATA ########################
train_until1 = read.table("Data/trainset_GAMM_full.csv",header=TRUE,sep=",")
...
#sarebbero da togliere area, shift 3 
...
#sarebbero da togliere area, shift 3, u_in (solo lo smooth)
